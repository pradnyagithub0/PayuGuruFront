  ...
  return (
    ...
    >
      <path
        ...
        className="fill-light-gray" // Bootstrap does not have these specific colors by default; consider defining these in your CSS
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className="fill-neutral-gray" // Same as above, consider defining these in your CSS
      />
    </svg>
  );
};
